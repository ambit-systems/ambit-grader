...
Third-party source material this implementation is verified against. These are **not** Ambit works, and the repository's Apache-2.0 licence does not extend to them. Each remains under its own terms, so the repository does not carry a copy. Retrieve each from its source and check the digest.

## Decision Evidence Maturity Model (arXiv 2605.04093)

*Decision Evidence Maturity Model for Agentic AI: A Property-Level Method Specification.* Source: `https://arxiv.org/abs/2605.04093`. Retrieved on 2026-07-27.

SHA-256 of the retrieved PDF: `843c6026116c6f7026b7b46f1a9f09f9806cfce0254206b5ca0eaf1d7df823aa`
...
| §3.2 — adapter tier declares the fragment-to-property mapping | `adapters.normalise.is_decision_event` |
